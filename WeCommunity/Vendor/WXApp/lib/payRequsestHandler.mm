...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSString *)orderName withTotalPrice:(NSString *)priceTotal withOrderNo:(NSString *)orderno
{
    //================================
    //预付单参数订单设置
    //================================
...
//    [packageParams setObject: @"APP-001"        forKey:@"device_info"]; //支付设备号或门店号
    ...
    [packageParams setObject: priceTotal       forKey:@"total_fee"];       //订单金额，单位为分
