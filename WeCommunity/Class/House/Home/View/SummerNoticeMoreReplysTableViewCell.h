//
//  SummerNoticeMoreReplysTableViewCell.h
//  WeCommunity
//
...
@interface SummerNoticeMoreReplysTableViewCell : UITableViewCell

@property (nonatomic ,weak)IBOutlet UIImageView *cellUserImage;
