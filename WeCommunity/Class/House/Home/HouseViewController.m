...
- (void)viewDidLoad {
    ...
    [barButtonItemView.btnUserImageView sd_setImageWithURL:userInfo.headPhoto placeholderImage:[UIImage imageNamed:@"home_title_smile"]];
    ...
    switch (alertView.tag) {
        ...
        {//认证
            if (buttonIndex == 1) {
                ...
                [self pushVC:accreditation title:@"添加认证信息"];
            }
        }
            break;
        case 1001:
